...
-- personal imports
-- ]
local tex = require 'kickstart.snippets.tex.utils.conditions'
local auto_backslash_snippet = require('kickstart.snippets.tex.utils.scaffolding').auto_backslash_snippet
local symbol_snippet = require('kickstart.snippets.tex.utils.scaffolding').symbol_snippet
local single_command_snippet = require('kickstart.snippets.tex.utils.scaffolding').single_command_snippet
local postfix_snippet = require('kickstart.snippets.tex.utils.scaffolding').postfix_snippet
...
for k, v in pairs(postfix_math_specs) do
  table.insert(
    ...
    postfix_snippet(vim.tbl_deep_extend('keep', { trig = k, snippetType = 'autosnippet' }, v.context), v.command, { condition = tex.in_math })
  )
end
